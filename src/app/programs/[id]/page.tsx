      ...
      <div className="mx-auto w-[90%] gap-10 md:grid md:w-[80%] md:grid-cols-[auto_auto]">
        ...
        <article className="pb-20 [&_p]:mb-2">
          ...
          <section id="main">
            ...
            <div className="flex flex-row flex-wrap gap-2 pt-4 pb-8">
          ...
          */}
            ...
            <div className="mt-4 grid w-full grid-cols-2 gap-4 lg:inline-grid lg:grid-cols-[auto_1fr] lg:grid-rows-2">
              {/*Years*/}
              ...
              {/*Costs Table*/}
              <div className="col-span-2 flex flex-col gap-4 pl-2 lg:col-start-2 lg:row-span-2">
                <h3 className="text-lg font-bold">
                  Вартість навчання (2024/2025 н.р.)
                </h3>
                <div className="rounded-box border-base-content/5 bg-base-100 flex-1 overflow-x-auto border">
                  <TableSimple />
                </div>
              </div>
            </div>
          ...
          <section id="characteristics" className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p>
                  Об&#39;єкт вивчення: теорія, методологія наукового
                  дослідження, феномени, явища і проблеми сучасних економічних
                  процесів та систем.
                </p>
                <p>
                ...
                <p>
                  Теоретичний зміст: теоретико-методологічні засади дослідження
                  та розв`язання актуальних завдань у сфері економіки, що
                  створюють підґрунтя для інноваційних рішень теоретичного та
                  прикладного спрямування.
                </p>
                <p>
                  Методи, методики та технології включають систему
                  загальнонаукових та спеціальних методів, методик та
                  технологій, застосування яких уможливлює виконання
                  оригінального наукового дослідження у сфері економіки,
                  результати якого мають наукову новизну, теоретичну та
                  практичну цінність.
                </p>
                <p>
                  Інструменти та обладнання: інформаційно-комунікаційні системи,
                  пакети прикладних програм, прилади та обладнання, необхідні
                  для виконання наукових досліджень та забезпечення інноваційних
              ...
              <div>
                ...
                <p>
                  ...
                  фінансовоекономічній, інформаційно-аналітичній
                  (діагностичній), обліковоконтрольній, проектній сферах.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  сучасних наукових досягнень, впроваджувати інноваційні проекти
                  у переробці харчової сировини та виробництві продовольства,
                  міжнародній торгівлі, готельно-ресторанному господарстві,
                  туризмі.
                </p>
                <p>
                  Освітньо-наукова програма передбачає поєднання теоретичних
                  знань та практичну (в т.ч. педагогічну) підготовку. Навчання
                  проводиться в активному дослідницькому науковому середовищі,
                  що передбачає Використання інтерактивних, відкритих та
                  проблемних лекцій, семінарів і круглих столів із запрошенням
                  відомих фахівців і практиків з економіки та суміжних галузей
                  знань, участь у бізнес-тренінгах, використання кейс-методів, а
                  також застосування сучасних освітніх інформаційно
                  комунікаційних технологій і т.ін.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p>
                  ...
                  теоретичне та практичне значення, що передбачає глибоке
              ...
              <div>
                ...
                <p>
                  ...
                  основі системного наукового світогляду та загального
                  культурного кругозору із дотриманням принципів професійної
              ...
              <div>
                ...
                <p>
                  СК6. Здатність обґрунтовувати та готувати економічні рішення
                  на основі розуміння закономірностей розвитку
                  соціально-економічних систем і процесів із застосуванням
                  математичних методів та моделей.
                </p>
                <p>
                  СК7. Здатність ініціювати, розробляти і реалізовувати
                  комплексні наукові проєкти в економіці та дотичні до неї
                  міждисциплінарні підходи, проявляти лідерство та
                  відповідальність при їх реалізації; комерціалізувати
                  результати наукових досліджень та забезпечувати дотримання
          ...
          <section id="results" className="mt-12">
            ...
            <div>
              <p>
                ...
                економіки, управління соціально- економічними системами і на
                межі предметних галузей, а також дослідницькі навички, достатні
                для проведення фундаментальних і прикладних досліджень на рівні
